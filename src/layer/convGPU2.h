#ifndef SRC_LAYER_CONV_GPU2_H_
#define SRC_LAYER_CONV_GPU2_H_
#pragma once
...
public:
    ConvGPU2(int channel_in, int height_in, int width_in, int channel_out,
